...
Проект — ESP32 устройство «часы/аудио» с 4x7-сегментным дисплеем (74HC595), Bluetooth A2DP приёмником, SD плеером, Wi-Fi конфигом/синхронизацией времени и будильниками. Прошивка разбита на модули в `main/`.
