 ...
 *
 * @return size if written ringbuffer successfully, 0 otherwise
 */
size_t write_ringbuf(const uint8_t *data, size_t size);

/**
 * @brief  get total BT audio error count
 *
...
/**
 * @brief  get current BT audio ringbuffer size in bytes
 *
 * @return ringbuffer size in bytes, 0 if not allocated
 */
