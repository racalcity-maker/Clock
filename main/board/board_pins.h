...
#define PIN_ADC_KEYS GPIO_NUM_34
#define ADC_KEYS_CHANNEL ADC_CHANNEL_6

// FM radio (RDA5807M) I2C
#define PIN_RADIO_SCL GPIO_NUM_32
#define PIN_RADIO_SDA GPIO_NUM_33
